            ...
            for (int rowIndex = 0; rowIndex < matrix.Length; rowIndex++)
            {
                for (int colIndex = 0; colIndex < matrix[rowIndex].Length; colIndex++)
                {
                    ...
                    if (matrix[rowIndex][colIndex] != correctNum)
                    {
                        ...
                        for (int searchedRow = rowIndex; searchedRow < matrix.Length; searchedRow++) // start searching for the correct number
                        {
                            if (isSwaped)
                            {
                                break;
                            ...
                            {
                                if (matrix[searchedRow][searchedCol].Equals(correctNum)) // when we find the correct number we replace it with the wrong one
                                {
